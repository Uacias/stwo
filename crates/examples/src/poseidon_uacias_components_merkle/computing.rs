...
/// 2. Transition constraints (chaining WITHIN level, odd rows only):
///    a. Rate part: initial_state[0..8] = final_state_prev[0..8] + message[0..8] (ABSORB)
///    b. Capacity part: initial_state[8..16] = final_state_prev[8..16] (PRESERVE)
